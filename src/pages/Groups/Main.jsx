...
export const Main = ({ user, setUser, thememode, toggle, groupData, setgroupData }) => {
  ...
  const handleSubmit = e => {
    ...
    const addgroup = async () => {
      try {
        console.log(groupInput)
        const res = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/group/creategroup`, { groupInput: { ...groupInput, groupCode: groupCode }, })
  ...
  const handleJoin = e => {
    ...
    const addgroup = async () => {
      try {
        console.log(JoingCode)
        const res = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/group/joingroup`, { joincode })
        console.log(res.data.newgroup)
        setgroupflag((prev) => !(prev))
        console.log(groupData)
      } catch (err) {
  ...
  useEffect(() => {
    ...
    const getGroups = async () => {
      try {
        const res = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/group/getgroups/${user._id}`)//add user Id
