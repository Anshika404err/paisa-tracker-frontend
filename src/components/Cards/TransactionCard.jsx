...
const TransactionCard = ({ user, transactionData, key, thememode, toggle, setTransactionData, setUpdateFlag }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const submitbutton = async () => {
      try {
        ...
        const res = await axios.put(`${process.env.REACT_APP_BASE_URL}/api/transactions/editTransaction/${transactionData._id}`, { transInput });
  ...
  const handleDelete = async () => {
    try {
      const res = await axios.delete(`${process.env.REACT_APP_BASE_URL}/api/transactions/deleteTransaction/${transactionData._id}`);
      console.log(res.data);
      console.log(transactionData)
